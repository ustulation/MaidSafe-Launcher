...
//#include "maidsafe/launcher/ui/models/app_collection_new.h"
...
//AppCollectionNew::AppCollectionNew(QObject* parent)
...
//AppCollectionNew::ModelRoleContainer_t AppCollectionNew::roleNames() const {
//  return roles_;
//}

//int AppCollectionNew::rowCount(const QModelIndex&) const {
//  return data_collection_.size();
//}

//QVariant AppCollectionNew::data(const QModelIndex& index, int role /*= Qt::DisplayRole */) const {
//  QVariant return_val;
...
//void AppCollectionNew::AddData(const QString& name, const QColor& color) {
//  beginInsertRows(QModelIndex{}, data_collection_.size(), data_collection_.size());
//  data_collection_.emplace_back(name, color);
//  endInsertRows();
//}

//void AppCollectionNew::RemoveData(const QString& name) {
...
//void AppCollectionNew::UpdateData(const QString& name, const Data& new_data) {
//  for (std::size_t index{}; index < data_collection_.size(); ++index) {
//    if (data_collection_[index].name() == name) {
...
//void AppCollectionNew::UpdateData(const QString& name, const QString& new_name) {
//  for (std::size_t index{}; index < data_collection_.size(); ++index) {
//    if (data_collection_[index].name() == name) {
...
//void AppCollectionNew::UpdateData(const QString& name, const QColor& new_color) {
//  for (std::size_t index{}; index < data_collection_.size(); ++index) {
//    if (data_collection_[index].name() == name) {
...
//void AppCollectionNew::OnTimeout() {
//  auto id(qrand() % 256);
//  auto r(qrand() % 256);
//  auto g(qrand() % 256);
//  auto b(qrand() % 256);
...
//void AppCollectionNew::MoveData(int index_from, int index_to) {
...
//void AppCollectionNew::StartRandomAdd() {
//  timer_.start();
//}

//void AppCollectionNew::StopRandomAdd() {

//}

//void AppCollectionNew::StartRandomDelete() {

//}

//void AppCollectionNew::StopRandomDelete() {

//}

//void AppCollectionNew::StartRandomUpdate() {

//}

//void AppCollectionNew::StopRandomUpdate() {
